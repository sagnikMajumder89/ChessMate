...
export default function FindMatch({
  ...
  return (
    <div className="flex flex-col-reverse items-center justify-center px-4 lg:flex lg:flex-row lg:justify-center lg:items-center gap-6 w-full min-h-full mx-auto relative">
      {gameFinding && (
            ...
            <div className="space-y-2">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    {gameSettings.time / 60} min
                    {gameSettings.time / 60 !== 1 ? "s" : ""}
                ...
                <DropdownMenuContent className="w-[var(--radix-dropdown-menu-trigger-width)]">
                  {timeOptions.map((option) => (
                    <DropdownMenuItem
                      key={option.value}
                      onClick={() =>
                        setGameSettings({ ...gameSettings, time: option.value })
                      }
                      disabled={gameFinding}
                    >
                      {option.label}
            ...
            <div className="flex items-center justify-between p-2 rounded-md">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  setGameSettings({ ...gameSettings, rated: checked })
                }
                disabled={gameFinding}
              />
            </div>
