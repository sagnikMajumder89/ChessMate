...
export default function Home() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-4 p-5 w-full h-full">
      <div>
        <Chessboard arePiecesDraggable={false} />
      </div>
      <div className="text-center">
        <h1 className="text-2xl font-bold">
          Play Chess on the best website for free
        </h1>
        ...
        <div className="flex flex-col px-5 py-3 gap-5">
          <Button className="h-fit" onClick={() => router.push("/play")}>
            <Image src="/icons/play.webp" alt="Play" width={40} height={40} />
          ...
          <Button className="h-fit" onClick={() => router.push("/playBot")}>
            <Image src="/icons/robot.webp" alt="Play" width={40} height={40} />
            <div className="flex flex-col items-start">
              <p className="text-lg">Play Bots</p>
              <span className="text-black font-light text-[0.6rem] lg:text-[1rem]">
